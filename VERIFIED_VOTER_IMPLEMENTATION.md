...
```bash
cd /home/anchor/projects/this-is-us/worker
npx wrangler d1 execute WY_DB --command "SELECT COUNT(*) FROM verified_users WHERE status = 'verified';"
```

### 6. Revoke verified user
```bash
cd /home/anchor/projects/this-is-us/worker
npx wrangler d1 execute WY_DB --command "UPDATE verified_users SET status = 'revoked' WHERE user_id = 'firebase-uid-123';"
```
...
- [ ] Apply migration: `npx wrangler d1 execute WY_DB --file migrations_wy/0018_create_verified_users.sql`
