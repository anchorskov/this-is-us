...
**Impact:** 
- ✅ **Local Dev:** Export `BILL_SCANNER_ENABLED=true` before starting wrangler
...
- **Commands:** All wrangler d1, curl, jq commands needed
...
✅ No errors in wrangler dev console (no ❌ symbols)  
...
3. **Start wrangler dev** – In Terminal 1, run `npx wrangler dev --local`
...
8. **Review logs** – Look for 🚀📋📄✅ emoji prefixes in wrangler dev console
...
**Where to look:**
- `wrangler dev --local` console logs (🚀📋📄✅❌ prefixes)
...
**Common commands:**
```bash
# Kill any stray wrangler processes
pkill -f "wrangler dev" || true

# Check if migrations are applied
sqlite3 .wrangler/state/v3/d1/miniflare-*/d1.sqlite \
