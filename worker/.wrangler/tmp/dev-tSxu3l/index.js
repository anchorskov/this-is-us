...
__name(getSafeOrigin, "getSafeOrigin");
...
__name(validateCoords, "validateCoords");
...
__name(getEnvBindings, "getEnvBindings");
  ...
  async scheduled(event, env, ctx) {
    ...
    for (const ev of expiredEvents) {
      try {
        ...
        console.error(`\u{1F9E8} Failed to delete expired event asset:`, e);
      }
    }
...
// .wrangler/tmp/bundle-2Z7UJv/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-2Z7UJv/middleware-loader.entry.ts
