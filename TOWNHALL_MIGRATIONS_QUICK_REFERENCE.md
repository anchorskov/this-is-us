...
```bash
wrangler d1 execute EVENTS_DB --env production --file worker/migrations/0018_create_townhall_replies.sql
wrangler d1 execute EVENTS_DB --env production --file worker/migrations/0019_add_county_to_townhall_posts.sql
```
