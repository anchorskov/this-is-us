...
```bash
# Apply migrations
wrangler d1 execute EVENTS_DB --file worker/migrations/0018_create_townhall_replies.sql
wrangler d1 execute EVENTS_DB --file worker/migrations/0019_add_county_to_townhall_posts.sql

# Verify schema
wrangler d1 execute EVENTS_DB --command "SELECT sql FROM sqlite_master WHERE type='table' AND name='townhall_replies';"
```

### Preview Environment
```bash
wrangler d1 execute EVENTS_DB --env preview --file worker/migrations/0018_create_townhall_replies.sql
wrangler d1 execute EVENTS_DB --env preview --file worker/migrations/0019_add_county_to_townhall_posts.sql
```

### Production Environment
```bash
wrangler d1 execute EVENTS_DB --env production --remote --file worker/migrations/0018_create_townhall_replies.sql
wrangler d1 execute EVENTS_DB --env production --remote --file worker/migrations/0019_add_county_to_townhall_posts.sql
```
