...
- [ ] Run migrations in local: `wrangler d1 execute EVENTS_DB --file worker/migrations/0018_create_townhall_replies.sql`
- [ ] Run migrations in preview: `wrangler d1 execute EVENTS_DB --env preview --file worker/migrations/0018_create_townhall_replies.sql`
- [ ] Run migrations in production: `wrangler d1 execute EVENTS_DB --env production --file worker/migrations/0018_create_townhall_replies.sql`
