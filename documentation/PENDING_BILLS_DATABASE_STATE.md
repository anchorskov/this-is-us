...
- **Location:** `/home/anchor/projects/this-is-us/worker/.wrangler/state/v3/`
...
npx wrangler d1 execute WY_DB --local --file migrations_wy/0001_create_base_schema.sql
npx wrangler d1 execute WY_DB --local --file migrations_wy/0006_create_civic_items.sql
npx wrangler d1 execute WY_DB --local --file migrations_wy/0009_add_civic_item_ai_tags.sql
npx wrangler d1 execute WY_DB --local --file migrations_wy/0010_add_reason_summary_to_civic_item_ai_tags.sql
npx wrangler d1 execute WY_DB --local --file migrations_wy/0011_add_ai_summary_fields_to_civic_items.sql
