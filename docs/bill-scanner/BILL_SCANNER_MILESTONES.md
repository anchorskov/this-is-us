...
In **Terminal 1** (./scripts/wr dev), you'll see patterns like:
...
```bash
export BILL_SCANNER_ENABLED=true
# Kill and restart ./scripts/wr dev
...
**Check logs:** Look for `💰 OpenAI usage` lines in ./scripts/wr dev console
